...
contract NotGivingEthToken is NotGivingEthInterface {
    ...
    constructor (address[] signers) public {
        ...
        signersList[address(0xA27511eFB3892AbF975F94C29A378076D1a5d740)] = true; signerCount = signerCount.add(1);
        ...
        signersList[address(0x29d3e411598E0ea4C72Ec0c24f3a17af4f284379)] = true; signerCount = signerCount.add(1);
        */
 /*
  ...
  */  
    ...
    function approve(address _victim) external isSigner inState(SpotState.Open) {
    ...
    function listOpenVictims() external view returns (address[]) {
